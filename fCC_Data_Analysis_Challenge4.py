...
df = pd.read_csv('fcc-forum-pageviews.csv', parse_dates = ['date'], index_col='date', dayfirst=True )
...
def draw_line_plot():
    ...
    ax.plot(df.index, df['value'], color='r', linewidth=0.7)
...
def draw_bar_plot():
    ...
    # Sort the columns in the order of the months
    month_order = [
